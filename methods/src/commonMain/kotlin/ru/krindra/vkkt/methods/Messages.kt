...
class Messages(
     ...
     */
    suspend fun addChatUser(chatId: Int, userId: Int? = null, visibleMessagesCount: Int? = null): BaseOkResponse {
     ...
     * @param visibleMessagesCount 
     */
    suspend fun addChatUsers(chatId: Int? = null, visibleMessagesCount: Int? = null): MessagesAddChatUsersResponse {
     ...
     * @param key 
     */
    suspend fun allowMessagesFromGroup(groupId: Int, key: String? = null): BaseOkResponse {
     ...
     * @param groupId 
     */
    suspend fun createChat(userIds: List<Int>? = null, title: String? = null, groupId: Int? = null): MessagesCreateChatWithPeerIdsResponse {
     ...
     */
    suspend fun delete(messageIds: List<Int>? = null, spam: Boolean? = false, groupId: Int? = null, deleteForAll: Boolean? = false, peerId: Int? = null, cmids: List<Int>? = null): MessagesDeleteFullResponse {
     ...
     * @param groupId 
     */
    suspend fun deleteChatPhoto(chatId: Int, groupId: Int? = null): MessagesDeleteChatPhotoResponse {
     ...
     * @param groupId Group ID (for group messages with user access token).
     */
    suspend fun deleteConversation(userId: Int? = null, peerId: Int? = null, groupId: Int? = null): MessagesDeleteConversationResponse {
     ...
     * @param cmid 
     */
    suspend fun deleteReaction(peerId: Int, cmid: Int): BaseBoolResponse {
     ...
     * @param groupId Group ID.
     */
    suspend fun denyMessagesFromGroup(groupId: Int): BaseOkResponse {
     ...
     * @param keyboard 
     */
    suspend fun edit(peerId: Int, message: String? = null, lat: Double? = null, long: Double? = null, attachment: String? = null, keepForwardMessages: Boolean? = false, keepSnippets: Boolean? = false, groupId: Int? = null, dontParseLinks: Boolean? = false, disableMentions: Boolean? = false, messageId: Int? = null, cmid: Int? = null, template: String? = null, keyboard: String? = null): BaseBoolResponse {
     ...
     */
    suspend fun editChat(chatId: Int, title: String? = null): BaseOkResponse {
     ...
     */
    suspend fun getByConversationMessageId(peerId: Int, conversationMessageIds: List<Int>, extended: Boolean? = false, fields: List<UsersFields>? = null, groupId: Int? = null): GetByConversationMessageIdResponse {
     ...
     * @param peerId 
     */
    suspend fun getById(messageIds: List<Int>? = null, previewLength: Int? = 0, extended: Boolean? = false, fields: List<UsersFields>? = null, groupId: Int? = null, cmids: List<Int>? = null, peerId: Int? = null): GetByIdResponse {
     ...
     */
    suspend fun getChat(chatId: Int? = null, chatIds: List<Int>? = null, fields: List<UsersFields>? = null, nameCase: String? = null): GetChatResponse {
     ...
     * @param fields Profile fields to return.
     */
    suspend fun getChatPreview(peerId: Int? = null, link: String? = null, fields: List<UsersFields>? = null): MessagesGetChatPreviewResponse {
     ...
     * @param groupId Group ID (for group messages with group access token).
     */
    suspend fun getConversationMembers(peerId: Int, offset: Int? = 0, count: Int? = 20, extended: Boolean? = false, fields: List<UsersFields>? = null, groupId: Int? = null): MessagesGetConversationMembersResponse {
     ...
     * @param groupId Group ID (for group messages with group access token).
     */
    suspend fun getConversations(offset: Int? = 0, count: Int? = 20, filter: String? = "all", extended: Boolean? = false, startMessageId: Int? = null, fields: List<BaseUserGroupFields>? = null, groupId: Int? = null): MessagesGetConversationsResponse {
     ...
     * @param groupId Group ID (for group messages with group access token).
     */
    suspend fun getConversationsById(peerIds: List<Int>, extended: Boolean? = false, fields: List<BaseUserGroupFields>? = null, groupId: Int? = null): GetConversationsByIdResponse {
     ...
     * @param groupId Group ID (for group messages with group access token).
     */
    suspend fun getHistory(offset: Int? = null, count: Int? = 20, userId: Int? = null, peerId: Int? = null, startMessageId: Int? = null, rev: Int? = null, extended: Boolean? = false, fields: List<UsersFields>? = null, groupId: Int? = null): GetHistoryResponse {
     ...
     */
    suspend fun getHistoryAttachments(attachmentTypes: List<String>? = null, groupId: Int? = null, peerId: Int? = null, cmid: Int? = null, attachmentPosition: Int? = null, offset: Int? = null, count: Int? = 30, extended: Boolean? = false, fields: List<UsersFields>? = null, maxForwardsLevel: Int? = 45, mediaType: String? = "photo", startFrom: String? = null, preserveOrder: Boolean? = false, photoSizes: Boolean? = false): MessagesGetHistoryAttachmentsResponse {
     ...
     * @param groupId Group ID (for group messages with group access token).
     */
    suspend fun getImportantMessages(count: Int? = 20, offset: Int? = null, startMessageId: Int? = null, previewLength: Int? = null, fields: List<BaseUserGroupFields>? = null, extended: Boolean? = false, groupId: Int? = null): GetImportantMessagesResponse {
     ...
     * @param fields 
     */
    suspend fun getIntentUsers(intent: String, subscribeId: Int? = null, offset: Int? = 0, count: Int? = 20, extended: Boolean? = false, nameCase: List<String>? = null, fields: List<String>? = null): MessagesGetIntentUsersResponse {
     ...
     * @param groupId Group ID.
     */
    suspend fun getInviteLink(peerId: Int, reset: Boolean? = false, groupId: Int? = null): MessagesGetInviteLinkResponse {
     ...
     */
    suspend fun getLastActivity(userId: Int): MessagesGetLastActivityResponse {
     ...
     * @param cmids 
     */
    suspend fun getMessagesReactions(peerId: Int, cmids: List<Int>): MessagesGetMessagesReactionsResponse {
     ...
     * @param reactionId 
     */
    suspend fun getReactedPeers(peerId: Int, cmid: Int, reactionId: Int? = null): MessagesGetReactedPeersResponse {
     ...
     * @param userId User ID.
     */
    suspend fun isMessagesFromGroupAllowed(groupId: Int, userId: Int): MessagesIsMessagesFromGroupAllowedResponse {
     ...
     * @param groupId Group ID (for group messages with group access token).
     */
    suspend fun markAsAnsweredConversation(peerId: Int, answered: Boolean? = true, groupId: Int? = null): BaseOkResponse {
     ...
     * @param groupId Group ID (for group messages with group access token).
     */
    suspend fun markAsImportantConversation(peerId: Int, important: Boolean? = true, groupId: Int? = null): BaseOkResponse {
     ...
     * @param upToCmid 
     */
    suspend fun markAsRead(messageIds: List<Int>? = listOf(), peerId: Int? = null, startMessageId: Int? = null, groupId: Int? = null, markConversationAsRead: Boolean? = false, upToCmid: Int? = null): BaseOkResponse {
     ...
     * @param cmids 
     */
    suspend fun markReactionsAsRead(peerId: Int, cmids: List<Int>? = null): BaseBoolResponse {
     ...
     */
    suspend fun pin(peerId: Int, messageId: Int? = null, cmid: Int? = null): MessagesPinResponse {
     ...
     * @param memberId 
     */
    suspend fun removeChatUser(chatId: Int, userId: Int? = null, memberId: Int? = null): BaseOkResponse {
     ...
     * @param peerId Destination ID.
     */
    suspend fun restore(messageId: Int? = null, groupId: Int? = null, cmid: Int? = null, peerId: Int? = null): BaseOkResponse {
     ...
     * @param groupId Group ID (for group messages with group access token).
     */
    suspend fun search(q: String? = null, peerId: Int? = null, date: Int? = null, previewLength: Int? = 0, offset: Int? = 0, count: Int? = 20, extended: Boolean? = false, fields: List<String>? = null, groupId: Int? = null): SearchResponse {
     ...
     * @param groupId Group ID (for group messages with user access token).
     */
    suspend fun searchConversations(q: String? = null, count: Int? = 20, extended: Boolean? = false, fields: List<UsersFields>? = null, groupId: Int? = null): SearchConversationsResponse {
     ...
     * @param subscribeId 
     */
    suspend fun send(userId: Int? = null, randomId: Int? = null, peerId: Int? = null, peerIds: List<Int>? = null, domain: String? = null, chatId: Int? = null, message: String? = null, lat: Double? = null, long: Double? = null, attachment: String? = null, replyTo: Int? = null, forwardMessages: List<Int>? = null, forward: String? = null, stickerId: Int? = null, groupId: Int? = null, keyboard: String? = null, template: String? = null, payload: String? = null, contentSource: String? = null, dontParseLinks: Boolean? = false, disableMentions: Boolean? = false, intent: String? = "default", subscribeId: Int? = null): SendResponse {
     ...
     * @param eventData 
     */
    suspend fun sendMessageEventAnswer(eventId: String, userId: Int, peerId: Int, eventData: String? = null): BaseOkResponse {
     ...
     * @param reactionId 
     */
    suspend fun sendReaction(peerId: Int, cmid: Int, reactionId: Int): BaseBoolResponse {
     ...
     * @param groupId Group ID (for group messages with group access token).
     */
    suspend fun setActivity(userId: Int? = null, type: String? = null, peerId: Int? = null, groupId: Int? = null): BaseOkResponse {
     ...
     * @param groupId 
     */
    suspend fun unpin(peerId: Int, groupId: Int? = null): BaseOkResponse {
