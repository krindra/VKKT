...
class Widgets(
     ...
     * @param count 
     */
    suspend fun getComments(widgetApiId: Int? = null, url: String? = null, pageId: String? = null, order: String? = "date", fields: List<UsersFields>? = null, offset: Int? = 0, count: Int? = 10): WidgetsGetCommentsResponse {
     ...
     * @param count 
     */
    suspend fun getPages(widgetApiId: Int? = null, order: String? = "friend_likes", period: String? = "week", offset: Int? = 0, count: Int? = 10): WidgetsGetPagesResponse {
