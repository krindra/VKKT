...
class Wall(
     ...
     * @param postId 
     */
    suspend fun closeComments(ownerId: Int, postId: Int): BaseBoolResponse {
     ...
     */
    suspend fun createComment(postId: Int, ownerId: Int? = null, fromGroup: Int? = null, message: String? = null, replyToComment: Int? = null, attachments: List<String>? = null, stickerId: Int? = null, guid: String? = null): WallCreateCommentResponse {
     ...
     */
    suspend fun delete(ownerId: Int? = null, postId: Int? = null): BaseOkResponse {
     ...
     */
    suspend fun edit(postId: Int, ownerId: Int? = null, friendsOnly: Boolean? = false, message: String? = null, attachments: List<String>? = null, primaryAttachments: List<String>? = null, services: String? = null, signed: Boolean? = false, publishDate: Int? = null, lat: Double? = null, long: Double? = null, placeId: Int? = null, markAsAds: Boolean? = false, closeComments: Boolean? = false, donutPaidDuration: Int? = null, posterBkgId: Int? = null, posterBkgOwnerId: Int? = null, posterBkgAccessHash: String? = null, copyright: String? = null, topicId: Int? = null): WallEditResponse {
     ...
     */
    suspend fun editAdsStealth(postId: Int, ownerId: Int? = null, message: String? = null, attachments: List<String>? = null, signed: Boolean? = false, lat: Double? = null, long: Double? = null, placeId: Int? = null, linkButton: String? = null, linkTitle: String? = null, linkImage: String? = null, linkVideo: String? = null): BaseOkResponse {
     ...
     * @param fields 
     */
    suspend fun get(ownerId: Int? = null, domain: String? = null, offset: Int? = null, count: Int? = null, filter: String? = null, extended: Boolean? = false, fields: List<BaseUserGroupFields>? = null): GetResponse {
     ...
     * @param fields 
     */
    suspend fun getComment(commentId: Int, ownerId: Int? = null, extended: Boolean? = false, fields: List<BaseUserGroupFields>? = null): GetCommentResponse {
     ...
     */
    suspend fun getComments(ownerId: Int? = null, postId: Int? = null, needLikes: Boolean? = false, startCommentId: Int? = null, offset: Int? = null, count: Int? = null, sort: String? = null, previewLength: Int? = null, extended: Boolean? = false, fields: List<BaseUserGroupFields>? = null, commentId: Int? = null, threadItemsCount: Int? = 0): GetCommentsResponse {
     ...
     */
    suspend fun getReposts(ownerId: Int? = null, postId: Int? = null, offset: Int? = null, count: Int? = 20): WallGetRepostsResponse {
     ...
     * @param postId 
     */
    suspend fun openComments(ownerId: Int, postId: Int): BaseBoolResponse {
     ...
     * @param postId Post ID.
     */
    suspend fun pin(postId: Int, ownerId: Int? = null): BaseOkResponse {
     ...
     * @param topicId Topic ID. Allowed values can be obtained from newsfeed.getPostTopics method.
     */
    suspend fun post(ownerId: Int? = null, friendsOnly: Boolean? = false, fromGroup: Boolean? = false, message: String? = null, attachments: List<String>? = null, primaryAttachments: List<String>? = null, services: String? = null, signed: Boolean? = false, publishDate: Int? = null, lat: Double? = null, long: Double? = null, placeId: Int? = null, postId: Int? = null, guid: String? = null, markAsAds: Boolean? = false, closeComments: Boolean? = false, donutPaidDuration: Int? = null, muteNotifications: Boolean? = false, copyright: String? = null, topicId: Int? = null): WallPostResponse {
     ...
     * @param linkVideo Link video ID in format "<owner_id>_<media_id>".
     */
    suspend fun postAdsStealth(ownerId: Int, message: String? = null, attachments: List<String>? = null, signed: Boolean? = false, lat: Double? = null, long: Double? = null, placeId: Int? = null, guid: String? = null, linkButton: String? = null, linkTitle: String? = null, linkImage: String? = null, linkVideo: String? = null): WallPostAdsStealthResponse {
     ...
     * @param reason Reason for the complaint: '0' - spam, '1' - child pornography, '2' - extremism, '3' - violence, '4' - drug propaganda, '5' - adult material, '6' - insult, abuse.
     */
    suspend fun reportPost(ownerId: Int, postId: Int, reason: Int? = null): BaseOkResponse {
     ...
     * @param muteNotifications 
     */
    suspend fun repost(object_: String, message: String? = null, groupId: Int? = null, markAsAds: Boolean? = false, muteNotifications: Boolean? = false): WallRepostResponse {
     ...
     */
    suspend fun restore(ownerId: Int? = null, postId: Int? = null): BaseOkResponse {
     ...
     * @param commentId Comment ID.
     */
    suspend fun restoreComment(commentId: Int, ownerId: Int? = null): BaseOkResponse {
     ...
     * @param fields 
     */
    suspend fun search(ownerId: Int? = null, domain: String? = null, query: String? = null, ownersOnly: Boolean? = false, count: Int? = 20, offset: Int? = 0, extended: Boolean? = false, fields: List<BaseUserGroupFields>? = null): SearchResponse {
     ...
     * @param postId Post ID.
     */
    suspend fun unpin(postId: Int, ownerId: Int? = null): BaseOkResponse {
